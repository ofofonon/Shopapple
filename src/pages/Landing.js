...
const Landing = () => {
  ...
  return (
      ...
      <div className="relative md:w-[60%] w-[90%] md:ml-[20%] ml-[5%] md:mt-[3.125rem] mt-[3.125rem]">
        <div className="relative inset-0 bg-gray-300/60 animate-pulse rounded-2xl h-[300px] w-[100%]" />
        <img src={img1} alt="img1"
          className="relative w-full opacity-0 transition-opacity duration-500"
           decoding="async"
          onLoad={(e)=>{e.currentTarget.classList.remove("opacity-0"); e.currentTarget.previousSibling.classList.add("hidden");}}
        />
      </div>
      ...
      <div className="relative md:w-[50%] w-[90%] md:ml-[25%] ml-[5%]">
  <div className="relative inset-0 bg-gray-300/60 animate-pulse rounded-2xl h-[300px] w-[100%]" />
  ...
  />
      ...
      <div className="relative md:w-[40%] w-[80%] md:ml-[30%] ml-[10%] mt-[2.1875rem]">
  <div className="relative inset-0 bg-gray-300/60 animate-pulse rounded-2xl h-[300px] w-[100%]" />
  ...
  />
      ...
      <div className="relative md:w-[40%] w-[80%] md:ml-[28%] ml-[10%] mt-[2.1875rem]">
  <div className="relative inset-0 bg-gray-300/60 animate-pulse rounded-2xl h-[300px] w-[100%]" />
  ...
  />
      ...
      <div className='w-full text-center mt-3'>
        <p className='md:text-2xl text-lg text-[#6A00B1] font-sans font-bold'>
        Join Purposeful Volunteering<br className=' md:hidden'/> Communities
        </p>
